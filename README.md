...
Edit **esm2_embedding.py** with own input file paths, then run locally or submit to HPC. This script will compute ESM‑2 (esm2_t36_3B_UR50D) embeddings for each sequence and save **esm2_embeddings.npy** and **gene_ids.csv** in the specified output directory.
